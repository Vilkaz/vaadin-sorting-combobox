...
import org.vaadin.client.SortingComboBoxClientRpc;
import org.vaadin.client.SortingComboBoxConstants;
import org.vaadin.client.SortingComboBoxServerRpc;
import org.vaadin.client.SortingComboBoxState;
...
//    private T type = T;
     ...
     * fact via SortingComboBoxClientRpc or selection handling won't complete.
     * </p>
     * <p>
    ...
    private SortingComboBoxServerRpc rpc = new SortingComboBoxServerRpc() {
        @Override
        public void createNewItem(String itemValue) {
            ...
            if (itemValue != null && !itemValue.isEmpty()) {
                if (getNewItemHandler() != null) {
                    ...
                    getRpcProxy(SortingComboBoxClientRpc.class)
            ...
            protected DataKeyMapper<T> createKeyMapper(
                ...
                return new KeyMapper<T>(identifierGetter) {
                    ...
                    public void remove(T removeobj) {
                        // never remove keys from SortingComboBox to support selection
     ...
     *            caption
     */
    public SortingComboBox(String caption) {
        this();
        setCaption(caption);
    }
     ...
     */
    public SortingComboBox(String caption, Collection<T> options) {
        this(caption);
    ...
    /**
     * Initialize the SortingComboBox with default settings and register client to
    ...
    private void init() {
        ...
        addDataGenerator((T data, JsonObject jsonObject) -> {
            ...
            if (style != null) {
                jsonObject.put(SortingComboBoxConstants.STYLE, style);
            }
            Resource icon = getItemIconGenerator().apply(data);
            if (icon != null) {
                String iconUrl = ResourceReference
                        .create(icon, SortingComboBox.this, null).getURL();
                jsonObject.put(SortingComboBoxConstants.ICON, iconUrl);
            }
        });
    }
    ...
    /**
     * Predicate to check {@link SortingComboBox} item captions against user typed
     * strings.
     *
     * @see SortingComboBox#setItems(CaptionFilter, Collection)
     * @see SortingComboBox#setItems(CaptionFilter, Object[])
     * @since 8.0
     */
    @FunctionalInterface
