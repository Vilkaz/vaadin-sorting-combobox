...
@Connect(org.vaadin.SortingComboBox.class)
public class SortingComboBoxConnector extends AbstractListingConnector
        ...
        registerRpc(SortingComboBoxClientRpc.class, new SortingComboBoxClientRpc() {
            ...
            public void newItemNotAdded(String itemValue) {
                if (itemValue != null && itemValue.equals(pendingNewItemValue)
                    ...
                    // handled but not added, perform (org-)selection handling
                    // immediately
    ...
    public void onStateChanged(StateChangeEvent stateChangeEvent) {
        ...
        Profiler.enter("SortingComboBoxConnector.onStateChanged update content");

        SortingComboBox widget = getWidget();
        ...
        Profiler.leave("SortingComboBoxConnector.onStateChanged update content");
    }
    ...
    @Override
    public SortingComboBox getWidget() {
        return (SortingComboBox) super.getWidget();
    }

    private SortingComboBox.DataReceivedHandler getDataReceivedHandler() {
    ...
    private static final Logger LOGGER = Logger
            .getLogger(SortingComboBoxConnector.class.getName());
