...
/**
 * Client side implementation of the SortingComboBox component.
 *
...
public class SortingComboBox extends Composite implements Field, KeyDownHandler,
    ...
    public class SortingComboBoxSuggestion implements Suggestion, Command {
         ...
         * by a server-side ItemStyleProvider.
    ...
    static class JsniUtil {
        ...
        public static void moveScrollFromEvent(final Widget widget,
            ...
            if (!Double.isNaN(deltaY)) {
                SortingComboBox filterSelect = (SortingComboBox) widget;
    ...
    public class SuggestionPopup extends VOverlay
        ...
        public void showSuggestions(final int currentPage) {
            ...
            debug("SortingComboBox.SP: showSuggestions(" + currentPage + ", "
                    + getTotalSuggestions() + ")");
        ...
        private void setNextButtonActive(boolean active) {
            if (enableDebug) {
                debug("SortingComboBox.SP: setNextButtonActive(" + active + ")");
            }
            if (active) {
                DOM.sinkEvents(down, Event.ONCLICK);
                down.setClassName(
        ...
        private void setPrevButtonActive(boolean active) {
            if (enableDebug) {
                debug("SortingComboBox.SP: setPrevButtonActive(" + active + ")");
            }
        ...
        public void selectNextItem() {
            debug("SortingComboBox.SP: selectNextItem()");
        ...
        public void selectPrevItem() {
            debug("SortingComboBox.SP: selectPrevItem()");
        ...
        public void selectFirstItem() {
            debug("SortingComboBox.SP: selectFirstItem()");
        ...
        public void selectLastItem() {
            debug("SortingComboBox.SP: selectLastItem()");
        ...
        private class LazyPageScroller extends Timer {
            ...
            @Override
            public void run() {
                debug("SortingComboBox.SP.LPS: run()");
                if (pagesToScroll != 0) {
            ...
            public void scrollUp() {
                debug("SortingComboBox.SP.LPS: scrollUp()");
            ...
            public void scrollDown() {
                debug("SortingComboBox.SP.LPS: scrollDown()");
                if (pageLength > 0
        ...
        private void scroll(double deltaY) {
            ...
            debug("SortingComboBox.SP: scroll() scrollActive: " + scrollActive);
        ...
        public void onBrowserEvent(Event event) {
            debug("SortingComboBox.SP: onBrowserEvent()");
        ...
        /**
         * Make the popup follow the position of the SortingComboBox when the page is
         * scrolled.
         */
        ...
        public void setPagingEnabled(boolean paging) {
            debug("SortingComboBox.SP: setPagingEnabled(" + paging + ")");
        ...
        public void setPosition(int offsetWidth, int offsetHeight) {
            debug("SortingComboBox.SP: setPosition(" + offsetWidth + ", "
                    + offsetHeight + ")");
            ...
            debug("SortingComboBox.SP:     desired[" + desiredWidth + ", "
                    + desiredHeight + "]");
        ...
        public boolean isJustClosed() {
            debug("SortingComboBox.SP: justClosed()");
        ...
        public void onClose(CloseEvent<PopupPanel> event) {
            if (enableDebug) {
                debug("SortingComboBox.SP: onClose(" + event.isAutoClosed() + ")");
            }
    ...
    public class SuggestionMenu extends MenuBar
        ...
        private VLazyExecutor delayedImageLoadExecutioner = new VLazyExecutor(
                100, () -> {
            debug("SortingComboBox.SM: delayedImageLoadExecutioner()");
        ...
        SuggestionMenu() {
            super(true);
            debug("SortingComboBox.SM: constructor()");
         ...
         * @param pageItemsCount page count
         */
        ...
        public void actOnEnteredValueAfterFiltering(String enteredItemValue) {
            debug("SortingComboBox.SM: doPostFilterSelectedItemAction()");
        ...
        public void onLoad(LoadEvent event) {
            debug("SortingComboBox.SM: onLoad()");
        ...
        @Deprecated
        public void selectFirstItem() {
            debug("SortingComboBox.SM: selectFirstItem()");
        ...
        @Deprecated
        public void selectLastItem() {
            debug("SortingComboBox.SM: selectLastItem()");
    ...
    public class DataReceivedHandler {
        ...
        public void serverReplyHandled() {
            ...
            // if (!initDone) {
            // debug("SortingComboBox: init done, updating widths");
         ...
         *            new selected item icon if sent by the server or   null to clear
         */
    ...
    /** For internal use only. May be removed or replaced in the future. */
    public SortingComboBoxConnector connector;
    ...
    /**
     * This method will create the TextBox used by the SortingComboBox instance. It is
     ...
     *
     * @since 7.1.5
     * @return TextBox instance used by this SortingComboBox
     */
    ...
    /**
     * This method will create the SuggestionPopup used by the SortingComboBox
     ...
     *
     * @since 7.1.5
     * @return SuggestionPopup instance used by this SortingComboBox
     */
    ...
    public void filterOptions(int page, String filter) {
        debug("SortingComboBox: filterOptions(" + page + ", " + filter + ")");
    ...
    public void updateReadOnly() {
        debug("SortingComboBox: updateReadOnly()");
        tb.setReadOnly(readonly || !textInputEnabled);
    }

    public void setTextInputAllowed(boolean textInputAllowed) {
        debug("SortingComboBox: setTextInputAllowed()");
    ...
    public void onNullSelected() {
        if (enableDebug) {
            debug("SortingComboBox: onNullSelected()");
        }
        dataReceivedHandler.cancelPendingPostFiltering();
    ...
    public void onKeyDown(KeyDownEvent event) {
        if (enabled && !readonly) {
            ...
            if (enableDebug) {
                debug("SortingComboBox: key down: " + keyCode);
            }
            if (dataReceivedHandler.isWaitingForFilteringResponse()
    ...
    private void inputFieldKeyDown(KeyDownEvent event) {
        if (enableDebug) {
            debug("SortingComboBox: inputFieldKeyDown(" + event.getNativeKeyCode()
                    + ")");
        }
    ...
    private void popupKeyDown(KeyDownEvent event) {
        if (enableDebug) {
            debug("SortingComboBox: popupKeyDown(" + event.getNativeKeyCode() + ")");
        }
    ...
    public void onKeyUp(KeyUpEvent event) {
        if (enableDebug) {
            debug("SortingComboBox: onKeyUp(" + event.getNativeKeyCode() + ")");
        }
        if (enabled && !readonly) {
            switch (event.getNativeKeyCode()) {
                case KeyCodes.KEY_ENTER:
    ...
    /**
     * Resets the SortingComboBox to its initial state.
     */
    private void reset() {
        debug("SortingComboBox: reset()");
    ...
    public void updateSuggestionPopupMinWidth() {
        debug("SortingComboBox: updateSuggestionPopupMinWidth()");
    ...
    public void onBlur(BlurEvent event) {
        ...
        if (BrowserInfo.get().isIE() && preventNextBlurEventInIE) {
            ...
            if (getElement().isOrHasChild(focusedElement) || suggestionPopup
                ...
                // IF the suggestion popup or another part of the SortingComboBox
    ...
    public void updateRootWidth() {
        debug("SortingComboBox: updateRootWidth()");
    ...
    private void handleMouseDownEvent(Event event) {
        ...
        if (event.getTypeInt() == Event.ONMOUSEDOWN) {
            debug("SortingComboBox: blocking mouseDown event to avoid blur");
            ...
            if (BrowserInfo.get().isIE() && focused) {
                ...
                debug("SortingComboBox: Going to prevent next blur event on IE");
            }
        }
    }
    ...
    public void onMouseDown(MouseDownEvent event) {
        debug("SortingComboBox.onMouseDown(): blocking mouseDown event to avoid blur");
    ...
    /**
     * Sets the empty selection caption for this SortingComboBox. The text is
